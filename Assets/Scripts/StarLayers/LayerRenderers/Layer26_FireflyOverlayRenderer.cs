...
public sealed class Layer26_FireflyOverlayRenderer : StarLayerRendererBase
{
    public override string Id => "firefly_overlay";
    ...
    {
        return StarLayerRenderUtil.Hash01(seed) > 0.75f;
    }
